...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "& '.\\.venv\\Scripts\\Activate.ps1'; python -m uvicorn backend.app.main:app --host 0.0.0.0 --port 8000 --workers 1" -WorkingDirectory "$PSScriptRoot"
