...
class ProgressTracker:
    ...
    def _publish_update(self):
        ...
        # Store enhanced_progress in Redis (disabled — job state now uses Redis Hash)
        # ProgressTracker output is not consumed by the frontend status endpoints.
        # The flat Redis Hash fields (progress, status, controls_count, etc.) are
        # the source of truth, updated directly by extractors via job_state.py.
